...
export default function Home() {
  ...
  return (
    <div className="w-full h-screen flex p-5 flex-col">
      <div className=" font-bold text-gray-500  justify-between w-full h-[70px] flex flex-row ">
        <div className="flex items-center justify-between flex-row  w-[600px]">
          ...
          {/* Menu Items */}
          <div className="relative" onClick={toggleFeaturesDropdown}>
            <div className="flex items-center">
              <p className="cursor-pointer mr-2 hover:text-black">Features</p>
              <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg">
                <path
                  stroke="#686868"
                  strokeWidth="2" // Use camelCase for JSX
                  fill="none"
                  d="m1 5 4-4 4 4"
                  className={`transition-transform duration-300 transform ${
                    isFeaturesDropdownOpen ? "rotate-180" : ""
                  }`}
                  style={{ transformOrigin: "center" }} // Ensure rotation is around the center
                />
              </svg>
            </div>
            {isFeaturesDropdownOpen && (
              <div className="absolute bg-white border rounded-xl border-gray-300 p-5 mt-2 w-[165px] shadow-md">
                <div className="flex flex-col p-1 font-bold cursor-pointer">
                  <div className="flex flex-row items-center mb-2">
                    ...
                    <p className="hover:text-black">Todo List</p>
                  </div>
                  <div className="flex flex-row items-center mb-2">
                    <svg
                      width="16"
                    ...
                    <p className="hover:text-black">Calendar</p>
                  </div>
                  <div className="flex flex-row items-center mb-2">
                    <svg
                      width="13"
                    ...
                    <p className="hover:text-black">Reminders</p>
                  </div>
                  <div className="flex flex-row items-center">
                    ...
                    <p className="hover:text-black">Planning</p>
                  </div>
                </div>
              </div>
            )}
          </div>
          <div className="relative" onClick={toggleCompanyDropdown}>
            <div className="flex items-center">
              <p className="cursor-pointer mr-2 hover:text-black">Company</p>
              <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg">
                <path
                  stroke="#686868"
                  strokeWidth="2" // Use camelCase for JSX
            ...
            {isCompanyDropdownOpen && (
              <div className="absolute bg-white border rounded-xl border-gray-300 p-5 mt-2 w-[165px] shadow-md">
                <div className="flex flex-col p-1 font-bold cursor-pointer">
                  <p className="hover:text-black">History</p>
                  <p className="hover:text-black">Our Team</p>
                  <p className="hover:text-black">Blog</p>
                </div>
              </div>
            )}
          </div>
        ...
        <div className="flex flex-row items-center justify-between w-[200px] p-5  ">
          <p className="hover:text-black cursor-pointer">Login</p>
          <p className="border border-gray-900 h-[40px] cursor-pointer hover:text-black items-center flex justify-center w-[100px] rounded-2xl">
            Register
          </p>
        </div>
      </div>
      <div className="w-full h-full   flex flex-row p-10">
        <div className="flex h-full flex-col w-[900px]  items-center justify-center p-16 ">
          <div className="w-[700px] flex-col  h-[550px] justify-between   flex ">
            <div className="flex flex-col">
              <h1 className="text-8xl font-bold">Make</h1>
              <h1 className="text-8xl font-bold">remote work</h1>
            </div>
            <div className="  h-auto w-[450px] text-xl text-gray-600">
            ...
            <p className="bg-black font-bold hover:text-black hover:bg-white cursor-pointer hover:border-black hover:border text-white w-[150px] rounded-xl h-[auto] flex p-3 items-center justify-center">
              Learn more
            </p>
            <div className="items-center justify-between flex-row flex    w-[500px] h-auto ">
